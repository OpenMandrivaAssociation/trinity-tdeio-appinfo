...
%lang(it) %{tde_datadir}/locale/it/LC_MESSAGES/tdeio_appinfo.mo
%lang(ka) %{tde_datadir}/locale/ka/LC_MESSAGES/tdeio_appinfo.mo
%lang(nl) %{tde_datadir}/locale/nl/LC_MESSAGES/tdeio_appinfo.mo
%lang(pl) %{tde_datadir}/locale/pl/LC_MESSAGES/tdeio_appinfo.mo
